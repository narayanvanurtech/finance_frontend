...
// Sales orders typically don't have phase-wise payment
...
export default function SalesOrderPreviewPage() {
  ...
  const getDoc = () =>
    selectedTemplate === "premium" ? (
      <PremiumTemplate quotation={salesOrder} phases={phases} />
    ) : (
      <ClassicTemplate quotation={salesOrder} phases={phases} />
    );
    ...
    <div className="max-w-5xl mx-auto py-8 px-2 min-h-screen flex flex-col gap-6">
      <div className="flex gap-4 mb-4 items-center">
        ...
        <PDFDownloadLink
          ...
          document={getDoc()}
          fileName={`sales-order-${salesOrder.number}.pdf`}
        >
          {({ loading }) => (
