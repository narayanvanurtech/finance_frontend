    ...
    return (
      <div className="max-w-7xl mx-auto p-4 sm:p-6 lg:p-8">
        <div className="text-center py-12">
          ...
          <Button
            onClick={() => router.push("/user/finance/vendors")}
            className="mt-4"
          >
  ...
  return (
    <div className="max-w-7xl mx-auto p-4 sm:p-6 lg:p-8 space-y-6">
      ...
      <div className="flex items-center justify-between">
        ...
        <Button
          variant="outline"
          onClick={() => router.push(`/user/finance/vendors/edit/${vendor._id}`)}
        >
            ...
            {(vendor.phone || vendor.contact) && (
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="font-medium">{vendor.phone || vendor.contact}</p>
                </div>
              </div>
            )}
      ...
      {/* Pagination */}
      {!purchaseOrdersLoading && purchaseOrders.length > 0 && pagination && (
        <Card>
