...
import { Person, Email, Business, AccountCircle } from "@mui/icons-material";

interface MeetingLeadInfoProps {
  meeting: Meeting;
}

const MeetingLeadInfo: React.FC<MeetingLeadInfoProps> = ({ meeting }) => {
    ...
    <div className="bg-white shadow rounded-lg">
      <div className="px-6 py-4 border-b border-gray-200">
        <h3 className="text-lg font-medium text-gray-900 flex items-center">
          <AccountCircle className="w-5 h-5 mr-2 text-indigo-600" />
          Lead Information
        </h3>
      </div>
      <div className="px-6 py-6">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="flex flex-col">
            ...
            <input
              type="text"
              value={lead?.fullName || (typeof meeting.leadId === 'string' ? meeting.leadId : "N/A")}
              disabled
...
export default MeetingLeadInfo;
