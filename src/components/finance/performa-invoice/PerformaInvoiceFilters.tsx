...
interface PerformaInvoiceFiltersProps {
...
const PerformaInvoiceFilters: React.FC<PerformaInvoiceFiltersProps> = ({
  onSearch,
  onClear,
  loading,
}) => {
      ...
      <div className="flex flex-col space-y-4">
        <div className="flex items-center space-x-4">
          <div className="relative flex-1">
            ...
            <Input
              placeholder="Search proforma invoices by number, title, or client..."
              className="pl-10"
...
export default PerformaInvoiceFilters;
