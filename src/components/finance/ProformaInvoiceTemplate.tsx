...
const ProformaInvoiceTemplate: React.FC<{
          ...
          <View style={styles.footerRow}>
            ...
            <View style={styles.taxBreakdownSection}>
              ...
              <View style={styles.taxBreakdownRow}>
                <Text style={styles.taxBreakdownLabel}>Taxable Value</Text>
                <Text style={styles.taxBreakdownLabel}>CGST Rate</Text>
                <Text style={styles.taxBreakdownLabel}>Amount</Text>
              </View>
              <View style={styles.taxBreakdownRow}>
                <Text style={styles.taxBreakdownValue}>
                  {subtotalBeforeTax.toFixed(2)}
                </Text>
                <Text style={styles.taxBreakdownValue}>9%</Text>
                <Text style={styles.taxBreakdownValue}>
                  {cgstTotal.toFixed(2)}
                </Text>
              </View>
              <View style={styles.taxBreakdownRow}>
                <Text style={styles.taxBreakdownLabel}>SGST/UTGST</Text>
                <Text style={styles.taxBreakdownLabel}>Rate</Text>
                <Text style={styles.taxBreakdownLabel}>Amount</Text>
              </View>
              <View style={styles.taxBreakdownRow}>
                <Text style={styles.taxBreakdownValue}></Text>
                <Text style={styles.taxBreakdownValue}>9%</Text>
                <Text style={styles.taxBreakdownValue}>
                  {sgstTotal.toFixed(2)}
                </Text>
              </View>
              <View style={[styles.taxBreakdownRow, { fontWeight: "bold" }]}>
                <Text style={styles.taxBreakdownLabel}>Total</Text>
                <Text style={styles.taxBreakdownLabel}>Tax Amount</Text>
              </View>
              <View style={[styles.taxBreakdownRow, { fontWeight: "bold" }]}>
                <Text style={styles.taxBreakdownValue}>
                  {subtotalBeforeTax.toFixed(2)}
